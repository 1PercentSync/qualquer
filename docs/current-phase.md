...
- 第一部分（实时 PT 必需组件）：Sobol + Blue Noise、Ray Cone LOD、Russian Roulette、Stochastic Alpha、IBL 旋转、Target sample count、Render resolution decoupling、Normal Map Specular AA
